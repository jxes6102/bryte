  ...
  <div class="home">
    ...
    <div class="w-full rounded-lg bg-white p-2 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700 flex flex-col items-center justify-center">
      ...
      <div 
        ...
        class="relative w-full p-2 text-neutral-800 flex flex-wrap items-center justify-between">
        <div 
        ...
        <div class="w-[calc(100%_-_25vw)] md:w-[calc(100%_-_200px)] h-auto text-base md:text-2xl flex flex-col items-center justify-center">
          <div>{{item.Title}}</div>
          <div>{{item.PreviewText}}</div>
          <div class="w-auto h-auto text-sm md:text-xl flex flex-wrap items-center justify-center">
